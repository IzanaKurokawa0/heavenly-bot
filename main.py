...
async def telegram_bot_main():
    ...
    print("🤖 ИНИЦИАЛИЗИРУЮ ТЕЛЕГРАМ БОТА...")
    ...
    try:
        ...
        async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
            ...
            text = f"""<b>🏆 HEAVENLY DYNASTY BOT</b>
...
/update - Обновить данные"""
        ...
        for command_name in club_commands.keys():
            async def club_handler(update: Update, context: ContextTypes.DEFAULT_TYPE, club=club_commands[command_name]):
...
def home():
    ...
    <!DOCTYPE html>
    <html>
    <head><title>🤖 Heavenly Bot</title></head>
    <body>
        <h1>🤖 Heavenly Dynasty Bot</h1>
        <p>✅ Status: Running</p>
        <p>Клубов: {len(data['clubs'])}</p>
        <p>Обновлено: {data['last_update'] or 'Never'}</p>
        <p><a href="https://t.me/Club_stats_bot">@Club_stats_bot</a></p>
    </body>
    </html>
    """
