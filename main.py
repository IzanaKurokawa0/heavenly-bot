...
# 🔥 ОБНОВЛЕННЫЙ ТОКЕН ТЕЛЕГРАМ
TELEGRAM_TOKEN = os.getenv('TELEGRAM_TOKEN', '8529987392:AAFA4ZcJMuzOkv3PFWB88Wxe1Pal31WEquA')  # НОВЫЙ ТОКЕН
...
✅ <b>Бот работает!</b>"""
        ...
        print("📱 Отправьте /start вашему боту @Club_stats_bot в Telegram")
        print("=" * 60)
        ...
        print("Убедитесь, что установлены зависимости: pip install python-telegram-bot[job-queue]==20.7")
    except Exception as e:
...
def home():
    ...
    <body>
        ...
        <ul>
            ...
            <li><a href="/update" onclick="fetch('/update', {{method: 'POST'}}).then(r => alert('Обновлено!'))">/update</a> - Обновить данные</li>
        </ul>
        <p><em>Telegram бот: @Club_stats_bot</em></p>
    </body>
    </html>
    """
