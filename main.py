...
async def check_api_status():
    ...
    global last_api_check, api_working
...
def main():
    ...
    signal.signal(signal.SIGINT, lambda s, f: asyncio.create_task(shutdown_signal()))
    signal.signal(signal.SIGTERM, lambda s, f: asyncio.create_task(shutdown_signal()))
